...
contract EnhancedSimpleEscrow{
    ...
    event DisputedRaised(address indexed initiator);
    ...
    constructor(address _seller, address _arbiter, uint256 _deliveryTimeout) {
        require(_deliveryTimeout> 0, "Delivery must be greater than zero");
    ...
    function confirmDeliver() external {
    ...
    function raiseDispute() external  {
        ...
        emit DisputedRaised(msg.sender);
    }
